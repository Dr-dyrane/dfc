  ...
  return (
    <div className="text-slate-200 p-4 min-h-screen">
      ...
      <div className="p-6 rounded shadow-md">
        ...
        {weatherData ? (
          <div>
            <h2 className="text-2xl font-semibold mt-4">Weather Information</h2>
            <p className="text-lg">Temperature: {weatherData.current.temperature_2m} °C</p>
            <p className="text-lg">Humidity: {weatherData.current.relativehumidity_2m}%</p>
            <p className="text-lg">Precipitation: {weatherData.current.precipitation} mm</p>
          </div>
        ) : (
