...
const Feature = () => {
  return (
    <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4">
      ...
      <div className="text-center p-4 md:p-8 border border-purple-200/10 bg-gradient-to-br from-blue-200 to-purple-200 mb-6 md:mb-12 rounded-3xl shadow-lg shadow-blue-500/50 overflow-hidden">
        <div className="max-h-80 md:max-h-full overflow-y-auto rounded-2xl">
          <img src="/current_weather.jpg" alt="Current Weather" />
        </div>
        <h2 className="text-xl font-semibold mt-4">Current Weather</h2>
      ...
      <div className="text-center  p-4 md:p-8 border border-purple-200/10 bg-gradient-to-br from-blue-200 to-purple-200 mb-6 md:mb-12 rounded-3xl shadow-lg shadow-blue-500/50 overflow-hidden">
        ...
        <h2 className="text-xl font-semibold mt-4">Hourly Weather</h2>
      ...
      <div className="text-center  p-4 md:p-8 border border-purple-200/10 bg-gradient-to-br from-blue-200 to-purple-200 mb-6 md:mb-12 rounded-3xl shadow-lg shadow-blue-500/50 overflow-hidden">
        ...
        <h2 className="text-xl font-semibold mt-4">7-Day Forecast</h2>
      ...
      <div className="text-center  p-4 md:p-8 border border-purple-200/10 bg-gradient-to-br from-blue-200 to-purple-200 mb-6 md:mb-12 rounded-3xl shadow-lg shadow-blue-500/50 overflow-hidden">
        ...
        <h2 className="text-xl font-semibold mt-4">Agricultural Recommendations</h2>
